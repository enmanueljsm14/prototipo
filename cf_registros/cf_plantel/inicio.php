...
<?php include_once("css/plugins/datepicker/bootstrap-material-datetimepicker.php") ?>
                        ...
                        <div class="header">
                            <h2 align="center">
                                 <ol class="breadcrumb breadcrumb-col-<?php echo $_SESSION['tema']?>">
                                    ...
                                    <li class="active"><i class="material-icons">location_city</i>Plantel</li>
                                </ol>
                            </h2>
       ...
       function nuevo()
        {
            ...
            $("#openModalRegistro").load("cf_registros/cf_plantel/formregistro.php");
        }
...
//**********************************************************//
        function modificar(x)
        {
            ...
            $('#openModalModificar').load('cf_registros/cf_plantel/formmodificar.php?valor='+x);
        }
//**********************************************************//    
    function eliminar(val){
        ...
        function (isConfirm) {
            if (isConfirm)
            {
                ...
                $( '#resultadoEliminar' ).load( 'cf_registros/cf_plantel/controlador.php?accion='+accion+'&val1='+val1);
